...
import com.jojonarte.pjsipspike.api.SipUri.ParsedSipContactInfos;
import com.jojonarte.pjsipspike.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
    ...
    /**
     * @deprecated This mode is not supported by pjsipspike for now.<br/>
     *             <a target="_blank" href=
     *             "http://www.pjsip.org/pjsip/docs/html/structpjsip__cred__info.htm#a8b1e563c814bdf8012f0bdf966d0ad9d"
     *             >Pjsip documentation</a>
     * @see #datatype
     ...
     * Note that in pjsipspike this value is not applied anymore in flavor to
