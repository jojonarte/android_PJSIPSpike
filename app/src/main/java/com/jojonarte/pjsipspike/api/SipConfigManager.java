...
public class SipConfigManager {
     ...
     * earpiece<br/>
     * Leave it managed by pjsipspike if you want to benefit auto detection
     * 
     * @see #setPreferenceBooleanValue(Context, String, boolean)
     */
     ...
     * And pjsipspike has different implementations for each ways, the backend
     * can be configured
     * 
     * @see #setPreferenceIntegerValue(Context, String, Integer)
     ...
     * Let pjsipspike automatically manage this setting if you want auto
     * detection to work
     * 
     * @see #setPreferenceBooleanValue(Context, String, boolean)
     */
     ...
     */
    public static final String AUTHORITY = "com.pjsipspike.prefs";
    private static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.pjsipspike";
    private static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.pjsipspike";
    ...
    /**
     * Helper method to retrieve a pjsipspike string config value
     * 
    ...
    /**
     * Helper method to retrieve a pjsipspike boolean config value
     * 
     * @param ctxt The context of your app
     * @param key the key for the setting you want to get
     * @param defaultValue the value you want to return if nothing found
    ...
    /**
     * Helper method to retrieve a pjsipspike float config value
     * 
     * @param ctxt The context of your app
     * @param key the key for the setting you want to get
     * @param defaultValue the value you want to return if nothing found
