 ...
 * This file is part of pjsipspike.
 *
 *  pjsipspike is free software: you can redistribute it and/or modify
 ...
 *
 *  pjsipspike is distributed in the hope that it will be useful,
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *  GNU General Public License for more details.
 *
 *  You should have received a copy of the GNU General Public License
 *  along with pjsipspike.  If not, see <http://www.gnu.org/licenses/>.
 *  
 *  This file and this file only is also released under Apache license as an API file
 */

package com.jojonarte.pjsipspike.api;

import android.content.ContentResolver;
import android.net.Uri;
import android.os.RemoteException;

import com.jojonarte.pjsipspike.api.ISipService;
...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.pjsipspike.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.jojonarte.pjsipspike.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.jojonarte.pjsipspike.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.pjsipspike.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.pjsipspike.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.pjsipspike.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.pjsipspike.phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "com.pjsipspike.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "com.pjsipspike.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global pjsipspike settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "com.pjsipspike.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_LAUNCH = "com.pjsipspike.service.CALL_LAUNCHED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.pjsipspike.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.pjsipspike.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_DELETED = "com.pjsipspike.service.ACCOUNT_DELETED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.pjsipspike.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.pjsipspike.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.pjsipspike.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.pjsipspike.service.MESSAGE_RECEIVED";
    /**
     * Broadcast sent when a conversation has been recorded.<br/>
     * This is linked to the call record feature of pjsipspike available through {@link ISipService#startRecording(int)}
     * <p>
     * Provided extras :
     * <ul>
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "com.pjsipspike.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.pjsipspike.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.pjsipspike.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "com.pjsipspike.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "com.pjsipspike.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.pjsipspike.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.pjsipspike.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "com.pjsipspike.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "com.pjsipspike.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "com.pjsipspike.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "com.pjsipspike.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "com.pjsipspike.phone.action.REWRITE_NUMBER";
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.pjsipspike.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "com.pjsipspike.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.pjsipspike.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "com.pjsipspike.db";
    /**
     * Base content type for pjsipspike objects.
     */
    public static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.jojonarte.pjsipspike";
    /**
     * Base item content type for pjsipspike objects.
     */
    public static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.jojonarte.pjsipspike";
